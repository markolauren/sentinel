$tableParams = @'
{
    "properties": {
		...
		{"name":"DstGeoRegion","type":"string"},
		{"name":"DstGeoCity","type":"string"},
		{"name":"DstGeoLatitude","type":"real"},
		{"name":"DstGeoLongitude","type":"real"},
		...
		{"name":"TransactionIdHex","type":"string"},
		...
		{"name":"DnsResponseIpCountry","type":"string"},
		{"name":"DnsResponseIpLatitude","type":"real"},
		{"name":"DnsResponseIpLongitude","type":"real"},
		{"name":"NetworkProtocol","type":"string"},
		{"name":"DnsQueryClass","type":"int"},
		{"name":"DnsQueryClassName","type":"string"},
		{"name":"DnsNetworkDuration","type":"int"},
		{"name":"DnsFlagsAuthenticated","type":"bool"},
		{"name":"DnsFlagsAuthoritative","type":"bool"},
		{"name":"DnsFlagsRecursionDesired","type":"bool"},
		{"name":"DnsSessionId","type":"string"},
		...
		{"name":"ThreatOriginalRiskLevel","type":"int"},
		{"name":"ThreatIsActive","type":"bool"},
		{"name":"ThreatFirstReportedTime","type":"string"},
		{"name":"ThreatFirstReportedTime_d","type":"datetime"},
		{"name":"ThreatLastReportedTime","type":"string"},
		...
		{"name":"SrcProcessName","type":"string"},
		{"name":"SrcProcessId","type":"string"},
		{"name":"SrcProcessGuid","type":"string"},
		{"name":"Dst","type":"string"},
		{"name":"DstPortNumber","type":"int"},
		{"name":"DstHostname","type":"string"},
		{"name":"DstDomain","type":"string"},
		{"name":"DstDomainType","type":"string"},
		{"name":"DstFQDN","type":"string"},
		{"name":"DstDvcId","type":"string"},
		{"name":"DstDvcScopeId","type":"string"},
		{"name":"DstDvcIdType","type":"string"},
		{"name":"DstDeviceType","type":"string"},
		{"name":"DvcAction","type":"string"},
		{"name":"DnsFlags","type":"string"},
		{"name":"DnsFlagsCheckingDisabled","type":"bool"},
		{"name":"DnsFlagsRecursionAvailable","type":"bool"},
		{"name":"DnsFlagsTruncated","type":"bool"},
		{"name":"DnsFlagsZ","type":"bool"},
...
Invoke-AzRestMethod -Path "(your sentinel path)/tables/DnsActivityLogs_CL?api-version=2021-12-01-preview" -Method PUT -payload $tableParams
